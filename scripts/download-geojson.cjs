...
const datasetId = "cbea3a67-9168-4c6d-8186-16ac1a795b5b";
const targetName = "Parks and Recreation Facilities - 4326.geojson";
const outputPath = path.join("public", "Parks and Recreation Facilities - 4326.geojson");
